...
from uniform_grid import get_fiducial_pixel_index_offset, get_fiducial_wavelength
...
def main():
    ...
    forest_lo_index = get_fiducial_pixel_index_offset(np.log10(forest_lo), coeff1=coeff1, log10lam0=log10lam0)
    forest_hi_index = get_fiducial_pixel_index_offset(np.log10(forest_hi), coeff1=coeff1, log10lam0=log10lam0)

    forest_wave = get_fiducial_wavelength(np.arange(forest_lo_index, forest_hi_index), coeff1, log10lam0)

    lo_indices = get_fiducial_pixel_index_offset(np.log10(forest_wave[0]*(1 + quasar_redshifts)), coeff1, log10lam0)
