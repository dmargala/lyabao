...
def main():
    ...
    plt.legend()
    plt.grid()
    plt.savefig(args.name+'-flux-mean.png', dpi=100, bbox_inches='tight')
    plt.close()
    ...
    plt.legend()
    plt.grid()
    plt.savefig(args.name+'-flux-var.png', dpi=100, bbox_inches='tight')
    plt.close()
    ...
    plt.legend()
    plt.grid()
    plt.savefig(args.name+'-ivar-total.png', dpi=100, bbox_inches='tight')
    plt.close()
